...
SOURCES = [{"title": "Familia Iptv ", "url": "http://bit.ly/29ojshgsgbsfhbfkjbbgjskbgjbsgjjhgbdjvbd6653735r3hfhbf", "fanart": "http://www.technobuffalo.com/wp-content/uploads/2016/02/tim-peake-photos-003.jpg", "genre": "IPTV TELEVISION", "date": "10.17.2015", "credits": "TVsupertuga", "thumbnail": "http://i86.servimg.com/u/f86/19/44/91/43/icon10.png"}]
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[plugin.video.familiaiptv-%s]: %s" %(addon_version, string))
...
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
addon = xbmcaddon.Addon('plugin.video.familiaiptv')
...
class NoRedirection(urllib2.HTTPErrorProcessor):
   ...
   https_response = http_response
addon = xbmcaddon.Addon('plugin.video.familiaiptv')
Q1RWQmFzZQ0K = base64.b64decode('aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvNVYzQUFxc3E=')
Q125xgFzZ76K = base64.b64decode('aHR1cDovL3Bhc3RlYmluLmNvbSR0FGRkFHQUZHQUdIQ=')
addon = xbmcaddon.Addon('plugin.video.familiaiptv')
