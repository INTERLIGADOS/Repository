...
SOURCES = [{"title": "Amerikano ", "url": "http://bit.ly/29ojshgsgbsfhbfkjbbgjskbgjbsgjjhgbdjvbd6653735r3hfhbf", "fanart": "http://www.technobuffalo.com/wp-content/uploads/2016/02/tim-peake-photos-003.jpg", "genre": "IPTV TELEVISION", "date": "10.17.2015", "credits": "TVsupertuga", "thumbnail": "http://i86.servimg.com/u/f86/19/44/91/43/icon10.png"}]

# http://www.technobuffalo.com/wp-content/uploads/02/tim-peake-photos-003.jpg
# https://raw.githubusercontent.com/M3U/icon.png

def addon_log(string):
    if debug == 'true':
        xbmc.log("[plugin.video.amerikano-%s]: %s" %(addon_version, string))
...
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
Q125xgFzZ76K = base64.b64decode('aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvNkRiNFVQRWE=')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL4JpdCgseS8yZHNPQ2gz')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL2JLdC5seS8y5HNPQ2gz')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL2JpdC9seS8yZHNPQ2gz')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
   Q125xgFzZ76K = base64.b64decode('aHR0cDovL7JpdC5seF8yZHjPQ2gz')
class NoRedirection(urllib2.HTTPErrorProcessor):
   def http_response(self, request, response):
       return response
   https_response = http_response
